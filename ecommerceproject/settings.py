...
SECRET_KEY = "django-insecure-^ko0(@nbhw7jcac6%bknh7)a0t)2nkqqdo88a#f(%kex%1hx$y"
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1","zakiy-makarim-ecommerceprojectassignment2.pbp.cs.ui.ac.id","10.0.2.2"]
